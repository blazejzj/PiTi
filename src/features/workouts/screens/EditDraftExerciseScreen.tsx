...
export default function EditDraftExerciseScreen() {
        ...
        return (
            <View className="flex-1 justify-center items-center bg-gray-50">
                <Text className="text-lg text-red-500">
                    Error: Exercise data not available.
                </Text>
            </View>
        );
    }
    ...
    return (
        ...
        >
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                <View className="flex-1 mt-20 p-4 border border-gray-200 rounded-xl bg-gray-50">
                    <View className="p-5 border-b border-gray-200">
                        <Text className="text-2xl font-extrabold text-neutral-800">
                            {data.exercise.exerciseName}
                        </Text>
                        <Text className="text-md text-gray-500 mt-1">
                            Editing Active Session Sets
                        </Text>
                    </View>
                    ...
                    >
                        <View className="mt-4 p-4 border border-gray-100 rounded-xl bg-gray-50">
                            <View className="flex-row items-center justify-between mb-2">
                                <Text className="text-sm font-semibold text-gray-600 w-1/5">
                                    Set #
                                </Text>
                                <View className="flex-row items-center w-4/5 ml-3">
                                    <Text className="text-sm font-semibold text-gray-600 w-1/4 text-center">
                                        Reps
                                    </Text>
                                    <Text className="text-sm font-semibold text-gray-600 w-1/3 text-center">
                                        Weight
                                    </Text>
                                    <Text className="text-sm font-semibold text-gray-600 w-1/4 text-center">
                                        Action
